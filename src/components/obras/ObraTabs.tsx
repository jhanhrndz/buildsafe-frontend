// src/components/obras/ObraTabs.tsx
...
const ObraTabs = ({ obraId, isCoordinador }: ObraTabsProps) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="p-6">
        {/* Aquí iría el contenido específico de cada pestaña */}
        {activeTab === 'areas' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-medium text-gray-900">Áreas de la Obra</h2>
              {isCoordinador && (
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-10 text-center text-gray-500">
              {/* Este es un espacio de contenido temporal - se reemplazaría con tu componente real de listado/gestión de áreas */}
              <p>No hay áreas registradas para esta obra.</p>
              {isCoordinador && (
